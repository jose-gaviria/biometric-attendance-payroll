...
export function Camera({ profile, debug, onClose, onEnrolled }: Props) {
  ...
  useEffect(() => {
    ...
    const alive = () => !stopped && generation.current === current;
          ...
          try {
            ...
            guide(
              ...
              profile
                ...
                : "Mira al frente. La identificación es automática.",
              true,
            );
            ...
            while (alive() && !complete) {
              ...
              if (data.status === "quality") {
                ...
                guide(
                  `quality:${data.reason}`,
                  messages[data.reason] ?? "Ajusta tu posición y mantente quieto.",
                );
  ...
  }, [enabled, device, retry, profile?.id, debug]);
  return (
    <section className="camera-page">
      <div className="page-heading">
        <div>
          ...
          <h1>{profile ? "Registrar rostro" : "Identificación facial"}</h1>
      ...
      {profile && !enabled ? (
        <div className="consent panel">
          ...
          <p>
            Capturaremos seis muestras para identificarte en este laboratorio.
            Se guardan representaciones numéricas del rostro; las fotos y el
            video no se conservan.
          </p>
          <p>
            El administrador puede eliminar tus datos faciales desde Personas.
          ...
          <label className="check">
            ...
            />
            Acepto registrar mis datos faciales para identificación en este
            laboratorio.
          </label>
          ...
          <div className="camera-layout">
            ...
            >
              ...
              <div className="camera-label">
                <span className="dot" /> Cámara local · CPU
              </div>
              {result && (
                <div
                  className={
                ...
                >
                  ...
                  <strong>
                    {result.accepted ? result.name : "Persona no reconocida"}
                  </strong>
                  <span>
                    {result.accepted
                      ? "Identidad confirmada"
